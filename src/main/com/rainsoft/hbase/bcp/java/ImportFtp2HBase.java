 ...
 */
public class ImportFtp2HBase {
    public static void main(String[] args) throws ParseException, IOException {
        //HBase表名
        String tablename = args[0];
        //Hbase表列簇
        String cf = "CONTENT_FTP";
        //bcp表字段
        String[] columns = FieldConstant.HBASE_FIELD_MAP.get("ftp");
    ...
    public static void importBcpJob(String tablename, String cf, String[] columns, String bcpPath) throws ParseException {
        ...
        JavaRDD<Row> filterFtpRDD = ftpRowRDD.filter(
                (Function<Row, Boolean>) v1 -> {
                    if (v1.length() < columns.length)
                        ...
                        String capTime = v1.getString(17);
         ...
         *导入HBase
         */
        ImportBcp2HBase.import2HBase(tablename, cf, columns, filterFtpRDD);
    }
}
