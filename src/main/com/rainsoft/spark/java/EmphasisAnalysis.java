...
public class EmphasisAnalysis {
    ...
    public static void run(String[] args) throws Exception {
        ...
        calendar.setTime(timeFormat.parse(countTime));
        ...
        //如果上次统计的结束时间是整小时的话sql语句无法获取到上一个小时统计的结果,故减1秒获取上一个小时的结果结果
         ...
         *      分组后每组只取一条数据
         */
        //第一步:以采集数据的IMSI号、小区号和分析数据的IMSI号和小区号的拼接作为Key
     ...
     * @throws Exception
     */
    public static void writeCount2HBase(JavaRDD<Row> infoRDD, HiveContext sqlContext, Date curDate, long step_length) throws Exception {
